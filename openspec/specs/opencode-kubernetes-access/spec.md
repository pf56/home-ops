# OpenCode Kubernetes Access

## Purpose

Define secure, read-only Kubernetes API access for OpenCode through a dedicated ServiceAccount and a nono-mediated credential route, without exposing the real token to the sandbox.
