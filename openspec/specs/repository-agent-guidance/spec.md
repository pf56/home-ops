...
Define the repository-wide guidance that agents use to understand project structure, follow declarative workflows, handle sensitive or unavailable operations, and report verified work accurately.
