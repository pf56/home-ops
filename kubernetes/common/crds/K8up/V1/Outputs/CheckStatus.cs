...
namespace Pulumi.Kubernetes.Types.Outputs.K8up.V1
{
    ...
    public sealed class CheckStatus
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.K8up.V1.CheckStatusConditions> Conditions;
        ...
        [OutputConstructor]
        private CheckStatus(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.K8up.V1.CheckStatusConditions> conditions,
