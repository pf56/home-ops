...
namespace Pulumi.Kubernetes.Types.Outputs.K8up.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class PruneStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.K8up.V1.PruneStatusConditions> Conditions;
        ...
        [OutputConstructor]
        private PruneStatus(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.K8up.V1.PruneStatusConditions> conditions,
