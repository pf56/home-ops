...
namespace Pulumi.Kubernetes.Types.Inputs.K8up.V1
{
    ...
    /// </summary>
    public class ArchiveStatusArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ArchiveStatusConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ArchiveStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ArchiveStatusConditionsArgs>());
        ...
        public ArchiveStatusArgs()
        {
        }
        public static new ArchiveStatusArgs Empty => new ArchiveStatusArgs();
    }
}
