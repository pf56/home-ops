...
namespace Pulumi.Kubernetes.Types.Inputs.K8up.V1
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.RestoreStatusConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.RestoreStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.RestoreStatusConditionsArgs>());
