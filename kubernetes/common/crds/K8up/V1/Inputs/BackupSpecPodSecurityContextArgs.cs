...
namespace Pulumi.Kubernetes.Types.Inputs.K8up.V1
{
    ...
    public class BackupSpecPodSecurityContextArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextSeLinuxOptionsArgs>? SeLinuxOptions { get; set; }

        /// <summary>
        /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        [Input("seccompProfile")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextSeccompProfileArgs>? SeccompProfile { get; set; }
        ...
        [Input("sysctls")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextSysctlsArgs>? _sysctls;

        /// <summary>
        /// Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch. Note that this field cannot be set when spec.os.name is windows.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextSysctlsArgs> Sysctls
        {
            get => _sysctls ?? (_sysctls = new InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextSysctlsArgs>());
            set => _sysctls = value;
        }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.BackupSpecPodSecurityContextWindowsOptionsArgs>? WindowsOptions { get; set; }
