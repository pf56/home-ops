...
namespace Pulumi.Kubernetes.Types.Inputs.K8up.V1
{
    ...
    /// </summary>
    public class ScheduleSpecRestoreArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("backend")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ScheduleSpecRestoreBackendArgs>? Backend { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ScheduleSpecRestorePodSecurityContextArgs>? PodSecurityContext { get; set; }

        /// <summary>
        /// Resources describes the compute resource requirements (cpu, memory, etc.)
        /// </summary>
        [Input("resources")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ScheduleSpecRestoreResourcesArgs>? Resources { get; set; }
        ...
        /// </summary>
        [Input("restoreMethod")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8up.V1.ScheduleSpecRestoreRestoreMethodArgs>? RestoreMethod { get; set; }
        ...
        public ScheduleSpecRestoreArgs()
        {
        }
        public static new ScheduleSpecRestoreArgs Empty => new ScheduleSpecRestoreArgs();
    }
}
