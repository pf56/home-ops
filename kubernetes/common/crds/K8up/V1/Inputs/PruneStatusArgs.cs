...
namespace Pulumi.Kubernetes.Types.Inputs.K8up.V1
{
    ...
    /// </summary>
    public class PruneStatusArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.PruneStatusConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.PruneStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.K8up.V1.PruneStatusConditionsArgs>());
        ...
        public PruneStatusArgs()
        {
        }
        public static new PruneStatusArgs Empty => new PruneStatusArgs();
    }
}
