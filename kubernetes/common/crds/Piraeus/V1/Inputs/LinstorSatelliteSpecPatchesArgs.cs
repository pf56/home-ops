...
namespace Pulumi.Kubernetes.Types.Inputs.Piraeus.V1
{
    ...
    /// </summary>
    public class LinstorSatelliteSpecPatchesArgs : global::Pulumi.ResourceArgs
    {
        [Input("options")]
        ...
        /// </summary>
        [Input("target")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Piraeus.V1.LinstorSatelliteSpecPatchesTargetArgs>? Target { get; set; }

        public LinstorSatelliteSpecPatchesArgs()
        {
        }
        public static new LinstorSatelliteSpecPatchesArgs Empty => new LinstorSatelliteSpecPatchesArgs();
    }
}
