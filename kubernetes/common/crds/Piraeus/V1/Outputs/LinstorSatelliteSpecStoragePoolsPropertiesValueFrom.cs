...
namespace Pulumi.Kubernetes.Types.Outputs.Piraeus.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class LinstorSatelliteSpecStoragePoolsPropertiesValueFrom
    {
        /// <summary>
        ...
        [OutputConstructor]
        private LinstorSatelliteSpecStoragePoolsPropertiesValueFrom(string nodeFieldRef)
        {
