...
namespace Pulumi.Kubernetes.Types.Outputs.Piraeus.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class LinstorSatelliteConfigurationSpecPatches
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Piraeus.V1.LinstorSatelliteConfigurationSpecPatchesTarget Target;

        [OutputConstructor]
        private LinstorSatelliteConfigurationSpecPatches(
            ImmutableDictionary<string, bool> options,

            string patch,

            Pulumi.Kubernetes.Types.Outputs.Piraeus.V1.LinstorSatelliteConfigurationSpecPatchesTarget target)
        {
            Options = options;
            Patch = patch;
            Target = target;
