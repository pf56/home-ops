...
namespace Pulumi.Kubernetes.Types.Outputs.Piraeus.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class LinstorSatelliteConfigurationSpecStoragePoolsPropertiesValueFrom
    {
        /// <summary>
        ...
        [OutputConstructor]
        private LinstorSatelliteConfigurationSpecStoragePoolsPropertiesValueFrom(string nodeFieldRef)
        {
