...
namespace Pulumi.Kubernetes.Types.Outputs.Piraeus.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class LinstorClusterSpecPatches
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Piraeus.V1.LinstorClusterSpecPatchesTarget Target;

        [OutputConstructor]
        private LinstorClusterSpecPatches(
            ImmutableDictionary<string, bool> options,

            string patch,

            Pulumi.Kubernetes.Types.Outputs.Piraeus.V1.LinstorClusterSpecPatchesTarget target)
        {
            Options = options;
            Patch = patch;
            Target = target;
