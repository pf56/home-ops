...
namespace Pulumi.Kubernetes.Types.Outputs.Piraeus.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class LinstorSatelliteConfigurationSpecStoragePoolsFileThinPool
    {
        /// <summary>
        ...
        [OutputConstructor]
        private LinstorSatelliteConfigurationSpecStoragePoolsFileThinPool(string directory)
        {
            Directory = directory;
        }
    }
